...
#endif
	_info.push_back(OptionInfo(OPTION_OXC, "cutsceneResolutionX", &cutsceneResolutionX, 320));
	_info.push_back(OptionInfo(OPTION_OXC, "cutsceneResolutionY", &cutsceneResolutionY, 200));
	_info.push_back(OptionInfo(OPTION_OXC, "pediaBgResolutionX", &pediaBgResolutionX, 320));
	_info.push_back(OptionInfo(OPTION_OXC, "pediaBgResolutionY", &pediaBgResolutionY, 200));
